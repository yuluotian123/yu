...
namespace GameLogic
{
    public interface IHfsmPseudoNodeData
    {
        string Id { get; set; }
    }

    public class HfsmAnyStateNodeData : GraphNodeData, IHfsmPseudoNodeData
    {
    ...
    public class HfsmReturnStateNodeData : GraphNodeData, IHfsmPseudoNodeData
    {
