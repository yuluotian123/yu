...
namespace GameLogic
{
    public partial class SerializationComponent2D : Component2D
    {
        public override int Priority => int.MinValue;

        public SerializableGameObjectData2D Save()
        {
            var snapshot = new SerializableGameObjectData2D
            {
        ...
        public void Load(SerializableGameObjectData2D snapshot)
        {
            if (snapshot == null)
                return;
